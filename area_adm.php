...
<body>
    <section class="area-adm tela-login ">
        <img src="./usuario/usuario<?php echo $usuarios['ID_USER'] ?>/<?php echo $usuarios['FOTO'] ?>" alt="foto-do-adminstrador">

        <div >
            
            <a href="index.php" class="links">Ir para Home</a>
            <a href="form_cad_livro.php" class="links">Cadastrar livros</a>
